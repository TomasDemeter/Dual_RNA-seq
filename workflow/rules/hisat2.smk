...
rule hisat2_H_sapiens:
    ...
    output:
        ...
        unmapped_1     = os.path.join(RESULT_DIR, "hisat2/H_sapiens/unmapped/{sample}_unmapped.1"),
        unmapped_2     = os.path.join(RESULT_DIR, "hisat2/H_sapiens/unmapped/{sample}_unmapped.2"),
    ...
    log:
        logs            = LOG_DIR + "hisat2/H_sapiens/{sample}_hisat2.log"
    conda:
        "hisat2_env"
    shell:
        """
